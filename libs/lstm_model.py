...
def train_lstm_model(X_train_seq: np.ndarray,
                     ...
                     epochs: int = 50,
                     learning_rate: float = 0.001,
                     save_path: Optional[str] = None) -> Tuple[LSTMClassifier, Dict]:
    """
    ...
    Args:
        ...
        y_val_seq: Validation labels (optional)
    ...
    """
    from libs.sequence_generator import create_dataloaders
